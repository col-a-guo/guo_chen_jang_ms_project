...
def stitch_and_split_csvs(csv1_path, csv2_path, output_base_path, test_size=0.2, random_state=42):
    ...
    data into train and test sets, saving each to separate files.
...
if __name__ == "__main__":
    ...
    csv2_path = "jan_20_combined.csv"  # Replace with your second CSV file path
    output_base_path = "stitched"  # Replace with the desired output base path
