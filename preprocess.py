...
# List of file paths
og_paths = [
    r"guo_chen_jang_ms_project\feb_6_multichannel_combined.csv",
    r"guo_chen_jang_ms_project\feb_6_streaming_combined.csv"
]
...
data.to_csv("feb_6_combined.csv", index=False)
