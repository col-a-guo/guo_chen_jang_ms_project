...
base_dirs = [r"C:\Users\r2d2go\Downloads\drive-download-20260306T084650Z-1-001"]  # Changed base directory
...
if combined_df_list:
    try:
        ...
        output_path =  r'march_6_extra_combined.csv' # Output to the same directory
